...
RARE_PRIOR_MATCHES = 16.0
COUNT_PRIOR_MATCHES = 4.0
FORM_PRIOR_MATCHES = 4.0
TFF_EARLY_PRIOR_MATCHES = 5.0
EXTERNAL_OPENER_PRIOR_MATCHES = 2.5
ESTABLISHED_SL_APPS = 8.0
GK_SAVES_PRIOR_MATCHES = 4.0
TEAM_CS_PRIOR_MATCHES = 8.0
EARLY_SEASON_FORM_CAP_APPS = 3.0
FIXTURE_CS_FLOOR = 0.72
FIXTURE_CS_CEILING = 1.38
FIXTURE_ATTACK_FLOOR = 0.62
FIXTURE_ATTACK_CEILING = 1.45
SAVE_MULT_FLOOR = 0.78
SAVE_MULT_CEILING = 1.32
MATCH_MODEL_BLEND = 0.62
HORIZON_WEIGHTS = (1.0, 0.28, 0.12)
HORIZON_WEEKS = 3
