...
FIXTURE_CS_FLOOR = 0.90
FIXTURE_CS_CEILING = 1.12
FIXTURE_ATTACK_FLOOR = 0.78
FIXTURE_ATTACK_CEILING = 1.24
SAVE_MULT_FLOOR = 0.82
SAVE_MULT_CEILING = 1.24
MATCH_MODEL_BLEND = 0.42
